...
parser = argparse.ArgumentParser(description='Parse TCX XML file.')
parser.add_argument('input', type=str, help='Input TCX file')
...
tcx = xmltodict.parse(open(args.input, "r", encoding="utf-8").read())
